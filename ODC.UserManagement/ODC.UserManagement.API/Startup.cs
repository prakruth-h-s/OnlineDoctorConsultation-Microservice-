...
namespace ODC.UserManagement.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.IncludeXmlComments(string.Format(@"{0}/ODC.UserManagement.API.xml", System.AppDomain.CurrentDomain.BaseDirectory));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "ODC.UserManagement.API");
            });
